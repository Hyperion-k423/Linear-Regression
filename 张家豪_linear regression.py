...
import math
# load the dataset
x_train, y_train = load_data()  #x_train is the population of a city,y_train is the profit of a restaurant in that city.
# print x_train
...
#the shape of x_train and y_train
